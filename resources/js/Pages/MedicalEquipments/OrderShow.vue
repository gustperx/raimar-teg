...
<template>
  <AppLayout title="Información del equipo médicos">
    <template #header>
    ...
    <div class="py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="flex flex-row justify-between pb-2">
          <div></div>
          <div>
            <JetButton type="button" class="mr-2">
              <Link :href="return_url">Regresar</Link>
            </JetButton>
            <JetButton type="button" class="mr-2">
              <Link :href="decline_url">Rechazar</Link>
            </JetButton>
        ...
        <CustomDetailsTable>
          <template #title>{{ equipment.description }}</template>
          <template #subtitle>Información sobre el equipo médicos.</template>
          <template #content>
            <CustomDetailsTableItem
              class="bg-gray-100"
              title="ID"
