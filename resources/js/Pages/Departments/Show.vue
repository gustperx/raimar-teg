...
<template>
  <AppLayout title="Información del departamento">
    <template #header>
    ...
    <div class="py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <CustomDetailsTable>
          <template #title>{{ department.name }}</template>
          <template #subtitle>Información sobre el departamento.</template>
          <template #content>
