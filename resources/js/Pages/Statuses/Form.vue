...
<template>
  <JetFormSection @submitted="actionSubmit">
    ...
    <template #description>
      Los estados permiten determinar cuál es el estado actual de un equipo de
      cómputo o equipo médico y ayuda como indicativo para saber si está
      operativo o en mantenimiento
    </template>
