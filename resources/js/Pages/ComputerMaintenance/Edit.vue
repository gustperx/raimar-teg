...
const form = useForm({
  ...
  transfer_date: null,
  transfer_date_fake: transforDate(props.computerEquipmentMovement.transfer_date),
  period_start: null,
  period_start_fake: transforDate(props.computerEquipmentMovement.period_start),
  period_end: null,
  period_end_fake: transforDate(props.computerEquipmentMovement.period_end),
...
const handleUpdate = () => {
  ...
  form.put(
    route("computer-maintenance.update", [
...
<template>
  <AppLayout title="Actualizar mantenimiento de equipos de cómputo">
    <template #header>
      <h2 class="font-semibold text-xl text-gray-800 leading-tight">
        Actualizar mantenimiento de equipos de cómputo
      </h2>
    </template>
