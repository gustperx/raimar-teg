...
const urlSearch = route("medical-equipments-movements.trash");
</script>

<template>
  <AppLayout title="Movimiento de equipos médicos en papelera de reciclaje">
    <template #header>
      <h2 class="font-semibold text-xl text-gray-800 leading-tight">
        Movimiento de equipos médicos en papelera de reciclaje
      </h2>
    </template>
