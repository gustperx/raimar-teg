...
import CustomList from "./ListOrder.vue";
...
<template>
  <AppLayout title="Equipos de cómputos disponibles">
    <template #header>
      <h2 class="font-semibold text-xl text-gray-800 leading-tight">
        Equipos de cómputos disponibles
      </h2>
    </template>
        ...
        <div class="flex flex-row justify-between pb-2">
          ...
          <div>
            <JetButton type="button">
              <Link href="/dashboard/available">Regresar</Link>
            </JetButton>
          </div>
        </div>
