...
const routeText = "categories.destroy";
  ...
  <CustomTableList>
    <template #header>
      <tr class="bg-gray-600">
        ...
        <th class="text-left text-white p-4 font-bold">Cantidad</th>
    ...
    <template #body>
      <tr
        v-for="{ id, name, amount, principal, updated_at, show_url, edit_url, can } in items"
        :key="id"
